...
<table className='md:table-auto table-fixed w-full overflow-hidden  mt-10' >
  ...
  <tbody className='text-gray-700'>
    {EnrolledCourses.map((course,index)=>( <tr key={index} className='border-b border-gray-500/20' > <td className='md:px-4 pl-2 md:pl-4 py-3 flex-items-center space-x-3'>
